...
--
-- Name: contents_tags; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: index_comments_on_content_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_comments_on_content_id ON comments USING btree (content_id);
...
--
-- Name: index_contents_on_user_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_contents_on_user_id ON contents USING btree (user_id);


--
-- Name: index_tags_on_body; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_tags_on_body ON tags USING btree (body);
...
CREATE TRIGGER tsvectorupdate BEFORE INSERT OR UPDATE ON contents FOR EACH ROW EXECUTE PROCEDURE tsvector_update_trigger('fulltext', 'pg_catalog.portuguese', 'title', 'body');
...
INSERT INTO schema_migrations (version) VALUES ('20141110000240');

INSERT INTO schema_migrations (version) VALUES ('20141110001057');

INSERT INTO schema_migrations (version) VALUES ('20141110001213');

INSERT INTO schema_migrations (version) VALUES ('20141110021207');

INSERT INTO schema_migrations (version) VALUES ('20141122173608');

INSERT INTO schema_migrations (version) VALUES ('20141122181335');

INSERT INTO schema_migrations (version) VALUES ('20141127224104');
